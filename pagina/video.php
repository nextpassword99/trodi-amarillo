        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://cdn.glitch.global/733d51da-7139-43b1-8bde-4ad3f2ea6bc2/PipedX.png?v=1689691903415"
                        class="d-block w-100" alt="Piped">
                    <div class="carousel-caption d-none d-md-block">
                        <a class="btn btn-warning" href="/video/piped-redirects.php">
                            Visualizar
                        </a>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="https://cdn.glitch.global/733d51da-7139-43b1-8bde-4ad3f2ea6bc2/Control%20ADB.jpg?v=1689691529118"
                        class="d-block w-100" alt="Control ADB">
                    <div class="carousel-caption d-none d-md-block">
                        <a class="btn btn-warning" href="/video/adb-control.php">
                            Visualizar
                        </a>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="https://cdn.glitch.global/733d51da-7139-43b1-8bde-4ad3f2ea6bc2/machu-picchu.png?v=1689691359163"
                        class="d-block w-100" alt="Machu Picchu">
                    <div class="carousel-caption d-none d-md-block">
                        <a class="btn btn-warning" href="/video/historia-machupicchu.php">
                            Visualizar
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                if (mysqli_num_rows($query) > 0) {
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        $contenido_html .= '<div class="title-img title-img-small" style="background-image: url(' . $imagen . ');"></div>';
