            ...
            <form class="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            <div class="mb-3">
                                <label for="urlMini" class="form-label">Cargar Miniatura</label>
                                <input class="form-control" type="file" id="urlMini" name="urlMini" accept="image/*"
                                    required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="mb-3">
                                <label for="urlVideo" class="form-label">Cargar Video</label>
                                <input class="form-control" type="file" id="urlVideo" name="urlVideo" accept="video/*"
                                    required>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descripcionVideo" name="descripcionVideo" rows="8"
                                    required></textarea>
                            </div>
                        </div>
                        <div class="mb-3">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (move_uploaded_file($imageTmpPath, $uploadFilePath)) {
            ...
            if (move_uploaded_file($videoTmpPath, $uploadFilePath)) {
                ...
                $sql = "INSERT INTO publicaciones (titulo, contenido, miniatura, urlvideo, url, link_descarga) VALUES ('$tituloVideo', '$descripcionVideo', '$uniqueImageName', '$uniqueVideoName', '$rutaVideo', '$linkDescarga')";
                if (mysqli_query($conn, $sql)) {
                    ...
                    <link rel=\'icon\' type=\'image/png\' href=\'https://cdn.glitch.global/9fa909c3-bb5a-4778-8d16-ef06342fa4db/Logo.png?v=1689436653865.png\' />
