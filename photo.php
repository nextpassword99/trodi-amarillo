...
<head>
  ...
  <title>FOTOGRAFIA - El blog de Trodi</title>
...
<body>
  ...
  <section>
    <div style="text-align: center">
      <button class="btn btn-warning" onclick="mostrarUploadImg()">Publicar fotografía</button>
    </div>
    <div id="mostrar_upload_img" style="display: none;">
  ...
  <section>
    <div class="container mt-2">
      <div class="row">
        ...
        $sql = "SELECT * FROM `photo` ORDER BY `photo`.`id` DESC"; 
